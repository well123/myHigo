...
class WebSocket{
    ...
    public static function getInstance($address,$port){
        if(!(self::$webSocket instanceof self)){
            self::$webSocket = new WebSocket($address,$port);
        }
    ...
    private function createSocket(){
        ...
        die("socket_option() failed".socket_strerror(socket_last_error()));
...
//        echo $msg."\n";
        file_put_contents('text.txt',$msg."\n",FILE_APPEND) ;
    }
